...
use App\Application\UseCase\ListSmsHistoryGeneral\ListSmsHistoryGeneralInput;
use App\Domain\Exception\InvalidDataException;
use App\Infra\Controller\{Controller, HttpRequest, HttpResponse};

class ListSmsHistoryGeneralController implements Controller
{
    public function __construct(private $listSmsHistory) {}

    public function serialize(array $params): ListSmsHistoryGeneralInput
    {
        $input = new ListSmsHistoryGeneralInput;
