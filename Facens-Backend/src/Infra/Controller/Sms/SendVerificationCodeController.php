...
use App\Application\UseCase\SendVerificationCode\SendVerificationCodeInput;
...
class SendVerificationCodeController implements Controller
{
    ...
    public function serialize(array $body): SendVerificationCodeInput
    {
        $schema = [            
            "type" => 'required',
            "isUser"     => 'required',
        ...
        $input = new SendVerificationCodeInput();
