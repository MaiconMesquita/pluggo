...
use App\Application\UseCase\AcceptInvitationSms\AcceptInvitationSmsInput;
...
class AcceptInvitationSmsController implements Controller
{
    ...
    public function serialize(array $params, array $args): AcceptInvitationSmsInput
    {
        $input = new AcceptInvitationSmsInput();
